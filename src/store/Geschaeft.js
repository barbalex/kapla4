...
export default types.model('Geschaeft', {
  ...
  ausloeser: types.maybe(types.union(types.string, types.integer, types.null)),
  ...
  fristAwel: types.maybe(types.union(types.string, types.integer, types.null)),
  ...
  gegenstand: types.maybe(types.union(types.string, types.integer, types.null)),
